...
\chapterpublicationnote
    {researcher2026observations} % this should be a normal citation reference to the bibliography item for the prepublished work
...
\clearpage
% Include the actual manuscript title here
\section{Manuscipt: Evaluating Synthetic Observations: Extending to Very Complex Environments}\label{sec:example_paper}
