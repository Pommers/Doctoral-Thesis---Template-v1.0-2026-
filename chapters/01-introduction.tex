...
Following this introduction, this template is structured in the following way. An example chapter is included in \cref{ch:chapter2}, where the layout is closer to a conventional research chapter. In \cref{ch:paper-example}, we include a published research paper by the candidate which expands upon the findings of the previous chapter. Following this \cref{ch:chapter4}, gives another example chapter for traditional research. In \cref{ch:discussion}, we synthesize the results from these three chapter and discuss their implications for addressing the question of the dissertation. Finally, in \cref{ch:conclusions}, we summarize the main findings of the thesis and place them in the broader context of the subject, before finally looking at future directions.
